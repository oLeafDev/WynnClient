...
import wynn.modules.combat.MageAura;
import wynn.modules.combat.TriggerBot;
import wynn.modules.movement.Fly;
import wynn.modules.movement.Sprint;
...
public class Main {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(new MageAura());
        Category.init();
        ...
        Category.COMBAT.modules.add(new MageAura());
        gui=new ClickGUI();
